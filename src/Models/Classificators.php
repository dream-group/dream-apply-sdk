...
class Classificators extends SimpleArray
{
    ...
    const CLASS_CONTACT_ROLE                = 'Contact role';
    const CLASS_INVOICE_TYPE                = 'Invoice type';
    const CLASS_INSTITUTION_SIZE            = 'Institution size';
    const CLASS_INSTITUTION_SUBJECT         = 'Institution subject';
    const CLASS_INSTITUTION_TYPE            = 'Institution type';
    const CLASS_AGREEMENT_TYPE              = 'Agreement type';
    const CLASS_TEACHING_LEVEL              = 'Teaching level';
    const CLASS_TRAINING_TYPE               = 'Training type';
    ...
    const CLASS_SENIORITY_LEVEL             = 'Seniority level';
    const CLASS_STAFF_CATEGORY              = 'Staff category';
}
