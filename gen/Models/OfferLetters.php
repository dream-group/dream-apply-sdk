...
/**
 * @generated
 * @implements ArrayAccess<int, OfferLetter>
 * @implements IteratorAggregate<int, OfferLetter>
 */
final class OfferLetters extends Collection
{
    use CollectionOfCreatable;

    protected function getItemClass()
    {
        return OfferLetter::class;
    }
     ...
     * @return OfferLetter
     */
    public function create(CreatableModels\OfferLetter $object)
    {
