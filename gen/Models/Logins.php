...
use Dream\Apply\Client\BaseModels\CollectionWithPaginator;
...
/**
 * @generated
 * @implements ArrayAccess<int, Login>
 * @implements IteratorAggregate<int, Login>
 */
final class Logins extends CollectionWithNoRecordRequests
{
    use CollectionWithFilter, CollectionWithPaginator;
